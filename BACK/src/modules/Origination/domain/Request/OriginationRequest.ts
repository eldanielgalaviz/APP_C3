...
export class OriginationRequest {
  ...
  @IsString()
  @MinLength(3, {
    message: "El prospect_contact_name debe tener al menos 3 caracteres",
  })
  @MaxLength(250, {
    message: "El prospect_contact_name no puede superar los 250 caracteres",
  })
  ...
  @IsString()
  @MinLength(3, {
    message: "El prospect_contact_role debe tener al menos 3 caracteres",
  })
  @MaxLength(250, {
    message: "El prospect_contact_role no puede superar los 250 caracteres",
  })
  ...
  @IsString()
  @MinLength(10, {
    message: "El prospect_contact_telephone debe tener al menos 10 caracteres",
  })
  @MaxLength(15, {
    message: "El prospect_contact_telephone no puede superar los 15 caracteres",
  })
  ...
  @MinLength(8, {
    message: "El prospect_contact_email debe tener al menos 8 caracteres",
  })
  @MaxLength(55, {
    message: "El prospect_contact_email no puede superar los 55 caracteres",
  })
  ...
  @IsNotEmpty({ message: "project_name es obligatorio" })
  project_name!: string;
